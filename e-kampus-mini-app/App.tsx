...
export default function App() {
  ...
  // Pre-load semua font vector icons agar tampil di web & Cloudflare Pages
  ...
  if (!fontsLoaded) {
    return (
      <View style={{ flex: 1, backgroundColor: '#F9F9FB', alignItems: 'center', justifyContent: 'center' }}>
        <Text style={{ color: '#000666', fontSize: 16, fontWeight: '600' }}>E-Kampus Mini</Text>
      </View>
    );
  }
